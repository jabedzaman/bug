      ...
      <div className="relative max-w-xl mx-auto">
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-lg leading-6 text-gray-500">
            Drop a mail and I will get back to you soon
          </p>
        </div>
        <div className="mt-12">
          <form action={process.env.NEXT_FORM_URL} method="POST" className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            <div>
